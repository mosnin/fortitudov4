...
const STEPS: ShowcaseStep[] = [
  {
    ...
    mockup: (
      <Frost title="Project routing" badge="Auto">
        ...
        <Row icon={ArrowRightLeft} title="Assigned → Alex Rivera" meta="ecommerce specialty · lowest load" tone="text-[#ff9a6e]" active />
  ...
  },
  {
    ...
    mockup: (
      <Frost title="Performance" badge="This month">
        ...
        <Row icon={TrendingUp} title="Alex Rivera" meta="7 launched · $1.6M" tone="text-[#ff9a6e]" right={<span className="text-[12px] font-medium text-white/70">#1</span>} active />
  ...
  },
  {
    ...
    mockup: (
      <Frost title="Approvals" badge="Audit on">
        ...
        <Row icon={ShieldCheck} title="Alex → reply to Sarah Chen" meta="email · house style" tone="text-[#ff9a6e]" right={<Chip label="Sent" tone="bg-[#ff7a45]/15 text-[#ff9a6e]" />} active />
  ...
  },
  {
    ...
    mockup: (
      <Frost title="Fixed-quote billing" badge="Studio plan">
        ...
        <Row icon={CreditCard} title="Fixed quote · per build" meta="50% up front · balance at launch" tone="text-[#ff9a6e]" />
