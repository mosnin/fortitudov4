      ...
      <Frost title="Build tracker" badge="Auto-tracked">
        ...
        >
          ...
          <span className="text-right">
            ...
            <span className="text-[10px] font-medium tracking-wide text-[#ff9a6e]">ON TRACK</span>
          </span>
        </motion.div>
        {[
  ...
  },
  {
    ...
    mockup: (
      <Frost title="Fixed quotes" badge="6 active">
        ...
        <Row icon={Home} title="Marketing site" meta="Maison Noir · $6.4k" right={<Chip label="Scoping" tone="bg-[#ff7a45]/15 text-[#ff9a6e]" />} />
  ...
  },
  {
    ...
    mockup: (
      <Frost title="Revisions" badge="This week">
        <Row icon={Users} title="Hero copy tweak" meta="requested 2 days ago" right={<Chip label="Open" tone="bg-[#ff7a45]/15 text-[#ff9a6e]" />} />
        <Row icon={Users} title="Checkout flow fix" meta="reported 1 week ago" right={<Chip label="In QA" tone="bg-sky-400/15 text-sky-300" />} />
        <Row icon={Users} title="New pricing page" meta="requested today" right={<Chip label="Open" tone="bg-[#ff7a45]/15 text-[#ff9a6e]" />} />
  ...
  },
  {
    ...
    mockup: (
      <Frost title="Messages" badge="This week">
        <Row icon={CalendarCheck} title="Sat 2:00, Phase 3 review" meta="Sarah Chen" tone="text-[#ff9a6e]" right={<Chip label="Confirmed" tone="bg-emerald-400/15 text-emerald-300" />} active />
