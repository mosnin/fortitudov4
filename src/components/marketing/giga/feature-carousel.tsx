...
const TABS: FeatureTab[] = [
  {
    ...
    blurb: 'Replies written in the house style, waiting before you open the thread.',
    heading: (
      <>
        Every thread, answered
        <br className="hidden sm:block" /> the way we would.
      </>
    ),
    description:
      'Helix reads each inbound against your live builds and drafts the reply in the house style, the moment the request lands.',
    image: '/marketing/product/realtors.jpg',
    imageAlt: 'Helix drafting a reply in the client inbox',
  },
  {
    icon: Target,
    tab: 'Smart insights',
    blurb: 'Every request scored against your real pipeline, so you know what to ship first.',
    heading: (
      <>
        Know exactly what
        <br className="hidden sm:block" /> to ship first.
      </>
    ),
    description:
      'Requests are scored against your real pipeline and ranked by intent, so the next best move is always at the top of the list, not buried in a spreadsheet.',
    image: '/marketing/product/brokerages.jpg',
    imageAlt: 'Helix ranking requests by intent',
  },
  {
    icon: KanbanSquare,
    tab: 'Pipeline automation',
    blurb: 'Reviews booked, builds advanced, the log kept current, automatically.',
    heading: (
      <>
        A pipeline that
    ...
    description:
      'Approve a change and the revision lands on the build, the confirmation goes back in the thread, and the phase advances, every action written down in plain language.',
    image: '/marketing/product/integrations.jpg',
    imageAlt: 'Helix advancing a build on the pipeline board',
  },
  {
    icon: Inbox,
    tab: 'Omnichannel inbox',
    blurb: 'Email, Slack, and calls in one worked queue, nothing slips.',
    heading: (
      <>
        Every channel, one
    ...
    description:
      'Email, Slack, and calls land in a single queue Helix keeps moving around the clock, so follow-up never slips and no request goes cold while you are heads-down building.',
    image: '/marketing/product/live-demo.jpg',
    imageAlt: 'Helix working an omnichannel inbox',
  },
];
    ...
    <Band className="py-24 sm:py-32">
      <div className="grid items-start gap-12 lg:grid-cols-2 lg:gap-16">
        ...
        <div className="lg:sticky lg:top-28">
          ...
          <BlurRise delay={0.1}>
            <div className="mt-8">
              <PillGhost href="/services" withArrow>
                Explore the agent
              </PillGhost>
            </div>
          </BlurRise>
