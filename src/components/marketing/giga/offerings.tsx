 ...
 * rotating capability chips (the one mechanic kept from the old design,
 * re-tinted for the dark shell).
 */
  ...
  return (
    ...
    >
      <Band>
        ...
        <div className="mt-14 grid max-w-6xl gap-4 sm:grid-cols-2 lg:grid-cols-3">
              ...
              >
                ...
                <div className="mt-4 flex flex-wrap gap-1.5">
                  {service.features.slice(0, 4).map((feature) => (
                    <span
                      key={feature}
                      className="rounded-[4px] bg-[var(--fx-charcoal-deep)] px-2 py-1 text-[10.5px] leading-none text-[var(--fx-muted)] transition-transform duration-300 ease-out hover:rotate-[6deg]"
                    >
                      {feature}
                    </span>
                  ))}
