...
const STEPS: ShowcaseStep[] = [
  {
    ...
    mockup: (
      <Frost title="Inbox" badge="Connected">
        <Row icon={Mail} title="Gmail" meta="reading + drafting" tone="text-[#f8cd02]" right={ON} active />
  ...
  },
  {
    ...
    mockup: (
      <Frost title="Calendar" badge="Connected">
        <Row icon={CalendarCheck} title="Google Calendar" meta="availability + booking" tone="text-[#f8cd02]" right={ON} active />
  ...
  },
  {
    ...
    mockup: (
      <Frost title="CRM sync" badge="Two-way">
        <Row icon={Database} title="HubSpot" meta="contacts + projects" tone="text-[#f8cd02]" right={ON} active />
  ...
  },
  {
    ...
    mockup: (
      <Frost title="Messaging" badge="Connected">
        <Row icon={MessageSquare} title="Slack" meta="updates + approvals" tone="text-[#f8cd02]" right={ON} active />
  ...
  },
  {
    ...
    mockup: (
      <Frost title="Documents" badge="Connected">
        <Row icon={FileSignature} title="DocuSign" meta="send for signature" tone="text-[#f8cd02]" right={ON} active />
