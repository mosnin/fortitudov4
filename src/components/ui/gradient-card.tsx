...
// Shared orange/amber edge-glow (replaces the original purple/blue).
const glow = {
  rest: "0 0 15px 3px rgba(249,115,22,0.7), 0 0 25px 5px rgba(234,88,12,0.5), 0 0 35px 7px rgba(251,191,36,0.35)",
  hover: "0 0 20px 4px rgba(249,115,22,0.9), 0 0 30px 6px rgba(234,88,12,0.7), 0 0 40px 8px rgba(251,191,36,0.5)",
} as const;
...
/**
 * Premium 3D-tilt gradient card in the Fortitudo palette (charcoal + orange
 * glow) with the studio's ASCII signature. Reserved for the marketing site's
 * main features.
 */
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(ellipse at bottom right, rgba(249,115,22,0.6) -10%, rgba(249,115,22,0) 70%), radial-gradient(ellipse at bottom left, rgba(251,191,36,0.5) -10%, rgba(251,191,36,0) 70%)",
          filter: "blur(40px)",
        }}
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle at bottom center, rgba(249,115,22,0.6) -20%, rgba(249,115,22,0) 60%)",
          filter: "blur(45px)",
        }}
