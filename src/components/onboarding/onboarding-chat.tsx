 ...
 *
 * Deliberately read as the SAME conversation surface the client will live in
 * once their build is running - just from the other side of the glass:
 *
 *   - The ACTIVE Helix question is a focal serif line that types in.
 *   - PAST Helix questions recede to small muted text.
 *   - The client's answers are right-aligned, softly-tinted bubbles.
 *
 ...
 *               `onTyped`. The one the client is answering right now.
 *  - past      → small muted text. What Helix already said.
 */
export function HelixSays({
  text,
  active = false,
  typing = false,
  onTyped,
...
/** The client's answer - right-aligned, softly tinted bubble. */
 ...
 * cards). Fades in a beat after the question finishes typing so the client
