 ...
 * of copy reads as if it's being written live, right now, by Helix.
 *
 * Built for the onboarding reveal (the kickoff draft Helix "writes"
 * before the dashboard loads). The whole emotional payload is the
 * SENSE that Helix is working in front of you - so the animation is
