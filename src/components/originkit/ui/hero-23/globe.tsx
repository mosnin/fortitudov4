...
/* eslint-disable @typescript-eslint/no-explicit-any, @typescript-eslint/no-unused-vars --
   vendored OriginKit globe; geojson features arrive untyped and stay that way. */
        ...
        const loadWorldData = async () => {
            try {
                ...
                const response = await fetch(
                    // Vendored same-origin (110m resolution, 232KB) — the drop fetched this
                    // from raw.githubusercontent.com at runtime, which is a third-party
                    // availability dependency the hero must not have.
                    "/originkit/hero-23-land.json"
                );
