...
const STEPS: Step[] = [
  {
    eyebrow: "A fixed quote",
    body: "You see one written price before the work starts. No hourly billing, moving target, or surprise invoice.",
  },
  {
    eyebrow: "Work in the open",
    body: "Your project page shows the real stages, files, decisions, and progress. You never have to chase a status update.",
  },
  {
    eyebrow: "Total handover",
    body: "The code, design files, campaign work, and logins are yours when the project launches. Nothing is locked to us.",
  },
];
...
export function ValueProp(): ReactNode {
  ...
  useEffect(() => {
    ...
    const DIM = "rgba(250,250,250,0.18)";
    const BRIGHT = "rgba(250,250,250,1)";
      ...
      >
        ...
        <div className="absolute inset-x-0 top-0 z-10 px-10 max-[850px]:px-6 pt-28 max-[850px]:pt-24 max-w-[1680px] mx-auto flex items-end justify-between gap-8">
          <h2 className="max-w-[22ch] text-[clamp(1.5rem,2.4vw,2.25rem)] font-medium leading-[1.15] tracking-tight text-foreground/80">
            Senior builders, one clear price, and a project you can actually watch.
          </h2>
          <Link
            href="/about"
