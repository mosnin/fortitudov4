...
const HEADLINE_LINES = ["Ready to build", "something real?"] as const;
    ...
    >
      <div className="max-w-[1680px] mx-auto px-10 max-[850px]:px-6 pb-32 max-[850px]:pb-24">
        <motion.div
          ...
          className="relative overflow-hidden rounded-3xl bg-[#0f0f12] min-h-[520px] max-[850px]:min-h-[420px]"
        >
          ...
          <div className="relative h-full flex flex-col justify-between p-14 max-[850px]:p-8 min-h-[inherit] text-white">
            ...
            <div className="flex items-end justify-between gap-8 max-[850px]:flex-col max-[850px]:items-start mt-10">
              ...
              >
                Tell us what you want. We give you a fixed price, then you watch
                us build it. You own everything the day it goes live.
              </motion.p>
              ...
              >
                <Link href="/contact" className="inline-flex items-stretch gap-1">
                  <span className="px-5 py-3 rounded-md bg-white text-neutral-900 text-xs font-medium tracking-widest uppercase border border-neutral-900/[0.08]">Talk to us</span>
