...
Design source: supplied Imageworks archive with upstream hashes in source-map.json. All public page compositions start from those components. Fortitudo yellow, logo and actual work replace source demo identity/content. Instrument Serif, floating navigation, arc, helix, reveal geometry, cards, FAQ and footer treatments come from the theme. This is source-faithful adaptation, not pixel identity with demo copy/photos.

Skills: Design OS plan and rendered/detail/motion review; Offers builder with complete 38-item declared audit (32 design passes, six economics/capacity unknowns); Influence seven-principle review and hash/declaration checker; Business OS category/homepage narrative; Humanize copy review. No independent buyer study, business-economics certification or claimed conversion uplift.
