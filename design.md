...
## Client-outcome imagery correction — 21 September 2026

The owner rejected agency-branded consumer goods and invented AI hardware. Fortitudo is an agency building client brands, commerce, websites, software and connected agents. Artwork must help a prospect imagine their own business improved by that work. A Fortitudo logo on a bottle, camera or thermostat communicates the wrong business model and must not ship.

Replace the ten shared stock photographs while retaining the paid theme's hierarchy, navigation, geometry and motion. References: the owner's silver product photograph and violet packaging campaign. Carry forward their directional studio light, tactile materials, precise contact shadows, optical clarity and carefully balanced space. Their product subjects and brand marks are not templates to copy.

Hierarchy stays headline and CTA first, campaign imagery second. Composition preserves all existing arc, Brief, Variations, Formats, service selector, pricing thumbnail and helix containers. Material alternates controlled silver/grey and violet/lavender treatments, grounded in the two references. Details require plausible ordinary devices, polished but legible interface concepts, real product materials, and accurate alt text. Responsive review covers square WebGL textures, wide editorial crops and portrait service frames; generate a composition variant when a crop would remove the subject.

Context mapping: an architecture-practice website; fragrance-label campaign; client portal; skincare packaging; fashion ecommerce campaign; booking application; tea-label identity; AI lead research/draft/review workflow; packaging beside matching mobile storefront; knowledge search with visible source documents. Consumer identities are clearly fictional studio concepts (FORME, SERA, MORROW), not claimed clients. Devices are ordinary unbranded presentation devices, not Fortitudo hardware. AI imagery shows business workflows and review controls, not decorative machines. Keep actual portfolio screenshots and the founder/brand artwork unchanged.

Creative OS: emphasis belongs to the client outcome; material and lighting establish consistency; varied subject matter expresses the actual service breadth. Details: inspect physical joins, screen text, object weight, edge highlights, label restraint and crop. Agent self-review against owner references, not an independent design verdict or premium certification. User correction overrides previous image-preservation instructions only for the ten stock photographs and rejects the unshipped agency-product generation batch.
